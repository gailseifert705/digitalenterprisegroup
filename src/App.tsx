...
function Header() {
  ...
  useEffect(() => {
    ...
    const updateLogoVisibility = () => {
      // Boss request: hide the header logo almost immediately after scrolling,
      // even while the visitor is still inside the hero section. Show it again
      // only when the page is back at the very top/hero start.
