...
import "./index.css";
import heroRecognitionStage from "./assets/hero-recognition-stage.png";
...
function Header() {
  ...
  useEffect(() => {
    ...
    const updateLogoVisibility = () => {
      // All devices: hide the logo almost immediately after a slight scroll,
      // then show it again when the user scrolls back to the very top.
