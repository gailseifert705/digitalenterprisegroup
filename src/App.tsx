...
function Header() {
  ...
  useEffect(() => {
    ...
    const MOBILE_LOGO_ALWAYS_VISIBLE = 980;

    const updateLogoVisibility = () => {
      // Desktop: hide the logo almost immediately after a slight scroll.
      // Mobile/tablet: keep the logo visible at all times per final feedback.
      const isMobileHeader = window.innerWidth <= MOBILE_LOGO_ALWAYS_VISIBLE;
      setShowHeroLogo(isMobileHeader || window.scrollY <= TOP_LOGO_VISIBILITY_LIMIT);
    };
